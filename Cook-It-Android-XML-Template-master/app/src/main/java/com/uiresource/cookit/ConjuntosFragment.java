...
public class ConjuntosFragment  extends Fragment implements OnTaskCompleted {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_fragment_conjuntos, null, false);

        ((Main)getActivity()).setupToolbar(R.id.toolbar, "CONJUNTOS PARA TI", R.color.colorPink, R.color.colorWhiteTrans, R.drawable.ic_burger);
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.recyclerViewCon);
    ...
    protected void consultaVestimentas() {
        try {
            String URL = Util.URL_SRV + "principal/recomendacionConjuntos";
